...
describe('DataDictionaryNode', function () {
  ...
  it('can render and toggle properties', function () {
    ...
    expect(wrapper.find('.data-dictionary-node__property').length).toBe(0); // expand node
    ...
    expect(wrapper.find('.data-dictionary-node__property').length).toBe(1); // unexpand node
