...
exports.SearchResultItemShape = exports.SearchItemShape = exports.SearchItemPropertyShape = exports.MatchedItemShape = exports.MatchedIndicesShape = exports.clearSearchHistoryItems = exports.addSearchHistoryItems = exports.getSearchHistoryItems = exports.getPropertyDescription = exports.parseDictionaryNodes = exports.graphStyleConfig = exports.downloadMultiTemplate = exports.downloadTemplate = exports.getType = exports.truncateLines = void 0;
  ...
  for (var i = 0; i < wordsList.length; i += 1) {
    ...
    if (concatTwoWords(currentLine, wordsList[i]).length > maxCharInRow) {
      ...
      if (wordsList[i].length > breakwordMinLength) {
        ...
        res.push("".concat(concatTwoWords(currentLine, wordsList[i].substring(0, breakPos)), "-")); // break the rest of the new word if it's still too long
