  ...
  var mapDispatchToProps = function mapDispatchToProps(dispatch) {
    return {
      onCloseOverlayPropertyTable: function onCloseOverlayPropertyTable() {
        return dispatch((0, _action.setOverlayPropertyTableHidden)(true));
      },
      onOpenMatchedProperties: function onOpenMatchedProperties() {
        return dispatch((0, _action.setHighlightingMatchedNodeOpened)(true));
      },
      onCloseMatchedProperties: function onCloseMatchedProperties() {
        return dispatch((0, _action.setHighlightingMatchedNodeOpened)(false));
      }
    };
  };
